...
class FaceProcessor extends NeuralNetwork_1.NeuralNetwork {
    ...
    runNet(input) {
        ...
        return tf.tidy(() => {
            ...
            return (0, fullyConnectedLayer_1.fullyConnectedLayer)(tf.reshape(bottleneckFeatures, [bottleneckFeatures.shape[0], -1]), params.fc);
        });
    }
    ...
    extractClassifierParams(weights) {
        return (0, extractParams_1.extractParams)(weights, this.getClassifierChannelsIn(), this.getClassifierChannelsOut());
    }
