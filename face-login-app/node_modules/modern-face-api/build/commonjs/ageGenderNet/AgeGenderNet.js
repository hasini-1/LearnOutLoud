...
class AgeGenderNet extends NeuralNetwork_1.NeuralNetwork {
    ...
    runNet(input) {
        ...
        return tf.tidy(() => {
            ...
            const reshaped = tf.reshape(pooled, [bottleneckFeatures.shape[0], -1]);
            const age = tf.reshape((0, fullyConnectedLayer_1.fullyConnectedLayer)(reshaped, params.fc.age), [
                bottleneckFeatures.shape[0],
            ]);
            const gender = (0, fullyConnectedLayer_1.fullyConnectedLayer)(reshaped, params.fc.gender);
            return { age, gender };
        });
    }
    forwardInput(input) {
    ...
    extractParamsFromWeigthMap(weightMap) {
        const { featureExtractorMap, classifierMap } = (0, util_1.seperateWeightMaps)(weightMap);
        this.faceFeatureExtractor.loadFromWeightMap(featureExtractorMap);
        return (0, extractParamsFromWeigthMap_1.extractParamsFromWeigthMap)(classifierMap);
    }
