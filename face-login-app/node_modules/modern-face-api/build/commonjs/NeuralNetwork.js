...
class NeuralNetwork {
    ...
    async loadFromUri(uri) {
        ...
        const weightMap = await (0, dom_1.loadWeightMap)(uri, this.getDefaultModelName());
    ...
    async loadFromDisk(filePath) {
        ...
        const { manifestUri, modelBaseUri } = (0, getModelUris_1.getModelUris)(filePath, this.getDefaultModelName());
