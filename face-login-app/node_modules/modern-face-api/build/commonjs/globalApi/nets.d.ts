...
import type { FaceLandmarks5 } from '../classes/FaceLandmarks5';
...
import { type ITinyYolov2Options, TinyYolov2 } from '../tinyYolov2';
 ...
 */
export declare const mtcnn: (input: TNetInput, options: MtcnnOptions) => Promise<WithFaceLandmarks<WithFaceDetection<object>, FaceLandmarks5>[]>;
/**
