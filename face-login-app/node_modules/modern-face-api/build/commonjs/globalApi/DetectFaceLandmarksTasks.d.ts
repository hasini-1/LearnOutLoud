...
export declare class DetectAllFaceLandmarksTask<TSource extends WithFaceDetection<object>> extends DetectFaceLandmarksTaskBase<WithFaceLandmarks<TSource>[], TSource[]> {
...
export declare class DetectSingleFaceLandmarksTask<TSource extends WithFaceDetection<object>> extends DetectFaceLandmarksTaskBase<WithFaceLandmarks<TSource> | undefined, TSource | undefined> {
