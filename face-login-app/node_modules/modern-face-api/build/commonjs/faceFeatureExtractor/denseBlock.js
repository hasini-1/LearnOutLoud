...
function denseBlock3(x, denseBlockParams, isFirstLayer = false) {
    return tf.tidy(() => {
        const out1 = tf.relu(isFirstLayer
            ...
            : (0, depthwiseSeparableConv_1.depthwiseSeparableConv)(x, denseBlockParams.conv0, [2, 2]));
        const out2 = (0, depthwiseSeparableConv_1.depthwiseSeparableConv)(out1, denseBlockParams.conv1, [1, 1]);
        const in3 = tf.relu(tf.add(out1, out2));
        const out3 = (0, depthwiseSeparableConv_1.depthwiseSeparableConv)(in3, denseBlockParams.conv2, [1, 1]);
...
function denseBlock4(x, denseBlockParams, isFirstLayer = false, isScaleDown = true) {
    return tf.tidy(() => {
        const out1 = tf.relu(isFirstLayer
            ...
            : (0, depthwiseSeparableConv_1.depthwiseSeparableConv)(x, denseBlockParams.conv0, isScaleDown ? [2, 2] : [1, 1]));
        const out2 = (0, depthwiseSeparableConv_1.depthwiseSeparableConv)(out1, denseBlockParams.conv1, [1, 1]);
        const in3 = tf.relu(tf.add(out1, out2));
        const out3 = (0, depthwiseSeparableConv_1.depthwiseSeparableConv)(in3, denseBlockParams.conv2, [1, 1]);
        const in4 = tf.relu(tf.add(out1, tf.add(out2, out3)));
        const out4 = (0, depthwiseSeparableConv_1.depthwiseSeparableConv)(in4, denseBlockParams.conv3, [1, 1]);
