...
class FaceFeatureExtractor extends NeuralNetwork_1.NeuralNetwork {
    ...
    forwardInput(input) {
        ...
        return tf.tidy(() => {
            ...
            let out = (0, denseBlock_1.denseBlock4)(normalized, params.dense0, true);
            out = (0, denseBlock_1.denseBlock4)(out, params.dense1);
            out = (0, denseBlock_1.denseBlock4)(out, params.dense2);
            out = (0, denseBlock_1.denseBlock4)(out, params.dense3);
