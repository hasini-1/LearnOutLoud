...
function extractorsFactory(extractWeights, paramMappings) {
    ...
    const extractSeparableConvParams = (0, extractSeparableConvParamsFactory_1.extractSeparableConvParamsFactory)(extractWeights, paramMappings);
    return {
        extractConvParams,
...
function extractParams(weights, config, boxEncodingSize, filterSizes) {
    const { extractWeights, getRemainingWeights } = (0, extractWeightsFactory_1.extractWeightsFactory)(weights);
    const paramMappings = [];
