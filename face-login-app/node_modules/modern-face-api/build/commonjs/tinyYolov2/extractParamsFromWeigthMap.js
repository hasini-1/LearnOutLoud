...
function extractorsFactory(weightMap, paramMappings) {
    const extractWeightEntry = (0, extractWeightEntryFactory_1.extractWeightEntryFactory)(weightMap, paramMappings);
    ...
    const extractSeparableConvParams = (0, extractSeparableConvParamsFactory_1.loadSeparableConvParamsFactory)(extractWeightEntry);
    return {
        extractConvParams,
...
function extractParamsFromWeigthMap(weightMap, config) {
    ...
    if (config.withSeparableConvs) {
        const numFilters = ((_a = config.filterSizes) === null || _a === void 0 ? void 0 : _a.length) || 9;
        params = {
            conv0: config.isFirstLayerConv2d
                ? extractConvParams('conv0')
                : extractSeparableConvParams('conv0'),
    ...
    (0, disposeUnusedWeightTensors_1.disposeUnusedWeightTensors)(weightMap, paramMappings);
