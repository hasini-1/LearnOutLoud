...
function extractorsFactory(extractWeights, paramMappings) {
    ...
    const extractSeparableConvParams = (0, common_1.extractSeparableConvParamsFactory)(extractWeights, paramMappings);
...
function extractParams(weights, numMainBlocks) {
    ...
    const middle_flow = {};
    (0, utils_1.range)(numMainBlocks, 0, 1).forEach(idx => {
