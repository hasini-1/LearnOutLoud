...
class DetectAllFaceLandmarksTask extends DetectFaceLandmarksTaskBase {
    async run() {
        ...
        const faces = this.input instanceof tf.Tensor
            ? await (0, dom_1.extractFaceTensors)(this.input, detections)
            : await (0, dom_1.extractFaces)(this.input, detections);
        ...
        return parentResults.map((parentResult, i) => (0, WithFaceLandmarks_1.extendWithFaceLandmarks)(parentResult, faceLandmarksByFace[i]));
    }
    withFaceExpressions() {
...
class DetectSingleFaceLandmarksTask extends DetectFaceLandmarksTaskBase {
    async run() {
        ...
        const faces = this.input instanceof tf.Tensor
            ? await (0, dom_1.extractFaceTensors)(this.input, [detection])
            : await (0, dom_1.extractFaces)(this.input, [detection]);
        ...
        return (0, WithFaceLandmarks_1.extendWithFaceLandmarks)(parentResult, landmarks);
    }
    withFaceExpressions() {
