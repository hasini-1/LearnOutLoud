...
class TinyFaceFeatureExtractor extends NeuralNetwork_1.NeuralNetwork {
    ...
    forwardInput(input) {
        ...
        return tf.tidy(() => {
            ...
            const normalized = tf.div((0, ops_1.normalize)(batchTensor, meanRgb), tf.scalar(255));
            let out = (0, denseBlock_1.denseBlock3)(normalized, params.dense0, true);
            out = (0, denseBlock_1.denseBlock3)(out, params.dense1);
            out = (0, denseBlock_1.denseBlock3)(out, params.dense2);
    ...
    extractParamsFromWeigthMap(weightMap) {
        return (0, extractParamsFromWeigthMapTiny_1.extractParamsFromWeigthMapTiny)(weightMap);
    }
    extractParams(weights) {
        return (0, extractParamsTiny_1.extractParamsTiny)(weights);
    }
}
