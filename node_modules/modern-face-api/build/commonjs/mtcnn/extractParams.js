...
function extractorsFactory(extractWeights, paramMappings) {
    const extractConvParams = (0, common_1.extractConvParamsFactory)(extractWeights, paramMappings);
    const extractFCParams = (0, common_1.extractFCParamsFactory)(extractWeights, paramMappings);
...
function extractParams(weights) {
    const { extractWeights, getRemainingWeights } = (0, common_1.extractWeightsFactory)(weights);
    const paramMappings = [];
    const { extractPNetParams, extractRNetParams, extractONetParams } = extractorsFactory(extractWeights, paramMappings);
